...
const links: HeaderLink[] = [
  ...
  { label: "Country Matrix", link: "https://docs.google.com/spreadsheets/d/1C-cVkQC2JXNBHE0KUEbJCWTpAnZSHtLIaquVn_UJfu8/edit?usp=sharing", showsAtHome: true, },
        ...
        >
          <div className={"max-w-7xl w-full flex justify-between items-center"}>
            <div className={"w-11 lg:w-16"}>
              <NextLink href={"/"}>
                <Image
                  src={logoUrl || "/symbol-white.png"}
                  alt={"SRM MUN 2024 logo"}
